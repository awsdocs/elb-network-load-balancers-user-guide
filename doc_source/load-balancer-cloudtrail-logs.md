# Logging API Calls for Your Network Load Balancer Using AWS CloudTrail<a name="load-balancer-cloudtrail-logs"></a>
...
All Elastic Load Balancing actions for Network Load Balancers are logged by CloudTrail and are documented in the [Elastic Load Balancing API Reference version 2015\-12\-01](http://docs.aws.amazon.com/elasticloadbalancing/latest/APIReference/)\. For example, calls to the `CreateLoadBalancer` and `DeleteLoadBalancer` actions generate entries in the CloudTrail log files\.
